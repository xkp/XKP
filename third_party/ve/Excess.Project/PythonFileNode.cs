...
namespace Excess.Project
{
	class PythonFileNode : FileNode
	{
		...
		private OAExcessFileItem automationObject;
		...
		public override object GetAutomationObject()
		{
			...
			{
				automationObject = new OAExcessFileItem(this.ProjectMgr.GetAutomationObject() as OAProject, this);
			}
		...
		protected override int QueryStatusOnNode(Guid guidCmdGroup, uint cmd, IntPtr pCmdText, ref QueryStatusResult result)
		{
			...
			else if(guidCmdGroup == ExcessMenus.guidExcessProjectCmdSet)
			{
                //td:
                //if(cmd == (uint)PythonMenus.SetAsMain.ID)
                //{
