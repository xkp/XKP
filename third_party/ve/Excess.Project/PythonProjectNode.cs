...
namespace Excess.Project
{
    ...
    public class PythonProjectNode : ProjectNode, IVsProjectSpecificEditorMap2
    {
        ...
        private void InitializeCATIDs()
        {
            ...
            this.AddCATIDMapping(typeof(OAExcessFileItem), typeof(OAExcessFileItem).GUID);
        ...
        public override Guid ProjectGuid
        {
            get
            {
                return typeof(ExcessProjectFactory).GUID;
            }
        }
        ...
        public override int GetGuidProperty(int propid, out Guid guid)
        {
            ...
            {
                guid = new Guid(GuidList.guidExcessLanguageString);
            }
            else
            {
        ...
        protected override bool IsItemTypeFileType(string type)
        {
            ...
            {
                if (String.Compare(type, "None", StringComparison.OrdinalIgnoreCase) == 0)
                    return false;
        ...
        {
            Guid[] result = new Guid[1];
            result[0] = typeof(ExcessBuildPropertyPage).GUID;
            return result;
        }

        public override object GetAutomationObject()
        {
            return new OAExcessProject(this);
        }
        ...
        public override bool IsCodeFile(string strFileName)
        {
            ...
            return (String.Compare(Path.GetExtension(strFileName), ".xs", StringComparison.OrdinalIgnoreCase) == 0);
