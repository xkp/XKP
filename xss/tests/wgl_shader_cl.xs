...
on update(){
	shader_mat1.resolution.x = app_width;
	shader_mat1.resolution.y = app_height;
	shader_mat2.resolution.x = app_width;
	shader_mat2.resolution.y = app_height;
	shader_mat1.time += 0.05;
	shader_mat2.time += 0.02;
