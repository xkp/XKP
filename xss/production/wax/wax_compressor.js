...
http.createServer(function(request, response) 
{
    ...
    if (pathname == '/home'){application.home(request, response);} else if (pathname == '/login'){application.login(request, response);} else if (pathname == '/do_login'){application.do_login(request, response);} else if (pathname == '/file_list'){application.file_list(request, response);} else if (pathname == '/compress'){application.compress(request, response);}
            else
            {
