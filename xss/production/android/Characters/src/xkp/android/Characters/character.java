...
import xkp.android.Characters.ActCharacters.XKPUtils;
		...
		extends XKPLayout
{
	...
	public character(Context context, AttributeSet attrs) {
		...
		ActCharacters.util.addViewGroup(this);
	...
	public void img_src_set(String value) {
		img_src = value;
		//ActCharacters.util.setResourceImageView(R.id.picture, value);
		ActCharacters.util.setResourceImageView(picture, value);
	}
