...
public class ActjBox2d_3 extends Activity {
	...
	private String[] mResources___resources1_XKPName = { "__image1", "__image2" };
	private String[] mResources___resources1_DroidName = { "smile_grin_48.png",
			"stone_12.jpg" };
	private Integer[] mResources___resources1_Type = {
			XKPPackage.BITMAP_RESOURCE, XKPPackage.BITMAP_RESOURCE };
	private Integer[] mResources___resources1_Id = { R.drawable.smile_grin_48,
			R.drawable.stone_12 };
	...
	private void bindViews() {
		...
		ViewTreeObserver mainLayoutViewTreeObserver = layoutapplication
				.getViewTreeObserver();
		if (mainLayoutViewTreeObserver.isAlive()) {
			mainLayoutViewTreeObserver
	...
	private void onLayoutStarted() {
		...
		XKPSpawner sp1 = new XKPSpawner(this, layoutapplication, "smiley_ball",
				100, 100, 95);
		...
		sp1.start();
		XKPPhysicBody __physics2 = new XKPPhysicBody(
				ActjBox2d_3.myWorld.getWorld(), ShapeType.POLYGON, __img1);
		...
		XKPPhysicBody __physics3 = new XKPPhysicBody(
				ActjBox2d_3.myWorld.getWorld(), ShapeType.POLYGON, __img2);
		...
		XKPPhysicBody __physics4 = new XKPPhysicBody(
				ActjBox2d_3.myWorld.getWorld(), ShapeType.POLYGON, __img3);
	...
	private void initInstances() {
		application = this;
		__resources1 = new XKPPackage(this, mResources___resources1_XKPName,
				mResources___resources1_DroidName,
